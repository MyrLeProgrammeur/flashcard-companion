...
const I18N = {
  fr: {
    ...
    "exams.newSub": "Matière (dossier racine du deck) et date approximative des résultats.",
  ...
  en: {
    ...
    "exams.newSub": "Subject (deck root folder) and approximate date of the results.",
