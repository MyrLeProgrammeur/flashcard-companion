...
const I18N = {
  fr: {
    ...
    "home.options": "Options · {name}",
    "home.moveTo": "Déplacer vers « {name} »",
    "home.newFolder": "Nouveau dossier…",
    "home.removeFromFolder": "Sortir du dossier",
    "home.renameFolder": "Renommer",
    "home.dissolveFolder": "Dissoudre le dossier",
    "home.newFolderTitle": "Nouveau dossier",
    "home.renameFolderTitle": "Renommer le dossier",
    "home.folderNameLabel": "Nom du dossier",
    "home.dissolveTitle": "Dissoudre « {name} » ?",
    "home.dissolveBody": "Les matières remontent à la racine. Aucune carte, aucune révision n'est touchée.",
    "home.cancel": "Annuler",
    ...
    "review.critiqueTitle": "Qu'est-ce qui n'allait pas ?",
    "review.critiquePlaceholder": "Ce qui manquait ou était faux…",
    "review.critiqueSend": "Régénérer",
    // ---- pdf viewer ----
  ...
  en: {
    ...
    "home.options": "Options · {name}",
    "home.moveTo": "Move to “{name}”",
    "home.newFolder": "New folder…",
    "home.removeFromFolder": "Move out of the folder",
    "home.renameFolder": "Rename",
    "home.dissolveFolder": "Dissolve the folder",
    "home.newFolderTitle": "New folder",
    "home.renameFolderTitle": "Rename the folder",
    "home.folderNameLabel": "Folder name",
    "home.dissolveTitle": "Dissolve “{name}”?",
    "home.dissolveBody": "Its subjects return to the root. No card and no review is touched.",
    "home.cancel": "Cancel",
    ...
    "review.critiqueTitle": "What was off or wrong?",
    "review.critiquePlaceholder": "What was missing or incorrect…",
    "review.critiqueSend": "Regenerate",
