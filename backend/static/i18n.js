...
const I18N = {
  fr: {
    ...
    "home.addSubjects": "Ajouter",
    "home.addSubjectsTitle": "Ajouter à « {name} »",
    "home.removeSubjects": "Retirer",
    "home.removeSubjectsTitle": "Retirer de « {name} »",
    "home.pickSubjects": "Choisis les matières à y ranger.",
    ...
    "home.archiveTitle": "Archiver",
    "home.archiveNote": "Choisis les matières ou dossiers à archiver.",
    "home.archiveFolder": "Archiver le dossier",
    "home.archiveFolderTitle": "Archiver « {name} » ?",
    "home.archiveFolderBody": "Toutes ses matières quittent l'accueil et les révisions. Le dossier est conservé tel quel : le désarchivage le restaure à l'identique.",
    "home.archivesTitle": "Archives",
    "home.archivesSub": "Hors de l'accueil et hors des révisions. L'historique est conservé.",
    "home.archivedMeta": "archivé",
    "home.unarchive": "Désarchiver",
    // ---- offline screen ----
  ...
  en: {
    ...
    "home.addSubjects": "Add",
    "home.addSubjectsTitle": "Add to “{name}”",
    "home.removeSubjects": "Remove",
    "home.removeSubjectsTitle": "Remove from “{name}”",
    "home.pickSubjects": "Pick the subjects to file into it.",
    ...
    "home.archiveTitle": "Archive",
    "home.archiveNote": "Pick the subjects or folders to archive.",
    "home.archiveFolder": "Archive the folder",
    "home.archiveFolderTitle": "Archive “{name}”?",
    "home.archiveFolderBody": "All its subjects leave the home screen and the reviews. The folder itself is kept as it is: unarchiving restores it identically.",
    "home.archivesTitle": "Archives",
    "home.archivesSub": "Out of the home screen and out of the reviews. The history is kept.",
    "home.archivedMeta": "archived",
    "home.unarchive": "Unarchive",
